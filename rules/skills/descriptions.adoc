...
The following table is a quick reference for all available skills. In-depth sections for each skill (except the primary combat skills) follow below the table.
