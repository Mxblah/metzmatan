...
Currently, dynamic Active Effects are supported on Actor skills and Dodge Bonus, and Weapon damage bonus. Further support will be added as the system develops.
...
* `@system.skills.perception.value / 5 / 2` (Though depending on targeted attribute key, the skill value may not be populated and thus may return `null` (0))
